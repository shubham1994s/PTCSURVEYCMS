...
namespace PTCSURVEYCMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(EmployeeVM model, string returnUrl)
        {
            ...
            Result = Repository.Login(model);

            switch (Result.status)
            {
                case "Success":

                    AddSession(Result.ADUM_USER_CODE, Result.AD_USER_TYPE_ID, Result.ADUM_LOGIN_ID, Result.ADUM_USER_NAME, Result.APP_ID);
        ...
        private void AddSession(int UserId, int RollID, string LoginId, string UserName, int AppId)
        {
            try
            {
                ...
                if (AppId != 0)
                {
                    ...
                    SessionHandler.Current.AppName_mar = ApplicationDetails.AppName_mar;
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            return RedirectToAction("SurveyList", "PTC");
        }
