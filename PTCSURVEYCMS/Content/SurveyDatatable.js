...
//
            ...
            { "render": function (data, type, full, meta) { return '<a  href="javascript:void(0)"title="Download"  style="cursor:pointer"   onclick="SendRemainder(' + full["PropertyId"] + ')"  >Send Remainder'; }, "width": "10%" },
