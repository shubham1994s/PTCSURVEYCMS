...
//        public List<PropertyMasterVM> getNamunaDetails(int AppId)
//        {
//            List<NamunaMaster> result = new List<NamunaMaster>();

//            using (var db = new DEVPTCSURVEYMALEGAONEntities(AppId))
//            {
//                result = db.NamunaMasters.Where(x => x.IsDelete == false).Select(x => new PropertyMasterVM
//                {
//                    PropertyId = x.NamunaId,
//                    NewPropertyNo = x.PropertyNo,
//                    PropertyNo = x.PropertyNo,
//            //        OldHouseNo1 = x.HouseNo,
//            //        PropOwnerFirstName = x.PropOwnerFirstName,
//            //        PropOwnerMiddleName = x.PropOwnerMiddleName,
